...
from closure_ea.dna.demo.coffee_store.closure_dna_demo import build_summary as build_dna_summary
from closure_ea.dna.demo.coffee_store.sqlite_demo import build_summary as build_sqlite_summary
...
def test_coffee_store_demo_shared_business_results():
    ...
    assert dna["genome"]["depth"] >= 1
    assert dna["genome"]["codons"] >= 1
